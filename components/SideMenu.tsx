      ...
      <AnimatePresence>
        {isOpen && (
          <>
            ...
            {/* Menu Panel - With Circular Reveal Animation */}
            <motion.div
              ...
              className="fixed inset-0 z-[98] flex items-center justify-center bg-[#0A0A0A]"
            >
                      ...
                      >
                        ...
                        >
                          <div className="flex items-baseline justify-between">
                            {/* Label */}
                            <motion.h2
                              className={`text-4xl md:text-6xl lg:text-7xl font-black tracking-tight transition-all duration-300 ${
                                isActive
                                  ? 'text-white'
                                  : 'text-gray-600'
                              }`}
                            ...
                            {/* Index */}
                            <motion.span
                              className="text-xs md:text-sm font-mono text-gray-600"
                              animate={{
